...
describe('Subgenerator entity-client of jhipster-antd-entity JHipster blueprint', () => {
        ...
        before(done => {
            helpers
                ...
                .withOptions({
                    'from-cli': true,
                    skipInstall: true,
                    blueprint: 'jhipster-antd-entity',
                    skipChecks: true
                })
                .withGenerators([
                    [
                        require('../generators/entity-client'), // eslint-disable-line global-require
                        'jhipster-jhipster-antd-entity:entity-client',
